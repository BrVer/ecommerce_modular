...
order_1 = Orders::PlaceOrder::Action.call(
  [{ quantity: 2, inventory_product_id: p1.id },
   { quantity: 1, inventory_product_id: p2.id }]
)
order_2 = Orders::PlaceOrder::Action.call(
  [{ quantity: 1,   inventory_product_id: p1.id },
   { quantity: 999, inventory_product_id: p2.id }]
)
